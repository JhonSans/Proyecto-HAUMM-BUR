	...
	<div class="contenedor">
		<main class="main-2">
			<nav>
				<div class="container">
					...
					<label for="responsive-menu"><a href="../VISTAS/Index_Usuario.php" class="text-title-primary">Haumm-Bur!<img
								src="../IMA/Logo.png" alt="Logo" class="logo"></a><span id="menu-icon"></span></label>
					<div id="overlay"></div>
					<ul>
						<li><img src="../IMA/User.PNG" alt="Admin" class="user-image"></li>
						<li><a href="../VISTAS/Index_Usuario.php" class="link-text">Inicio</a></li>
		...
		<section class="section-2">
			<div class="form-3">
				...
				<ul>
            		<li><h1>Iniciaste como Cliente</h1></li>
            		<li>
